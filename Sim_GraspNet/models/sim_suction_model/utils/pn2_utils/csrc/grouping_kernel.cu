...
at::Tensor GroupPointsBackward(
  ...
  auto grad_input = at::zeros({batch_size, channels, num_points}, grad_output.options());
  ...
  TORCH_CHECK(at::cuda::getApplyGrid(totalElements, grid, curDevice), "Too many elements to calculate");
